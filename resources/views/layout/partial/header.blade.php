    ...
    <aside class="max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-4 ml-4 block w-full -translate-x-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 xl:left-0 xl:translate-x-0 xl:bg-transparent">
      <div class="h-19.5">
        ...
        <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700" href="javascript:;" target="_blank">
          <img src="./assets/img/iconsurat.png" class="inline h-full max-w-full transition-all duration-200 ease-nav-brand max-h-8" alt="main_logo" />
          <span class="ml-1 font-semibold transition-all duration-200 ease-nav-brand">SIMASU BPS Kota Malang</span>
        </a>
      </div>
        ...
        <ul class="flex flex-col pl-0 mb-0">
          ...
          <li class="mt-0.5 w-full">
            <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="./pages/tables.html">
              ...
              <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Code</span>
            </a>
          </li>
          ...
          <li class="mt-0.5 w-full">
            <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="./pages/billing.html">
              ...
              <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Destination</span>
            </a>
          </li>
          ...
          <li class="mt-0.5 w-full">
            <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="./pages/virtual-reality.html">
              ...
              <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">District</span>
            </a>
          </li>
          ...
          <li class="mt-0.5 w-full">
            <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="./pages/provinsi.html">
              <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
              ...
              <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Mail</span>
            </a>
          </li>
            ...
            <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="./pages/provinsi.html">
              <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                ...
                <g fill="none" fill-rule="nonzero">
                  <path d="M0,172v-172h172v172z" fill="none"></path>
                    <g fill="#000000">  
                      <path d="M 16.919922 2.953125 C 13.291922 2.953125 10.035391 5.0581562 8.5253906 8.2851562 C 7.9493906 8.1261563 7.3433281 8.0449219 6.7363281 8.0449219 C 3.0263281 8.0449219 0.009765625 11.063437 0.009765625 14.773438 C 0.009765625 18.482438 3.0263281 21.5 6.7363281 21.5 L 11.398438 21.5 A 2.545 2.545 0 0 0 13.736328 23.046875 A 2.545 2.545 0 1 0 13.736328 17.955078 A 2.545 2.545 0 0 0 11.400391 19.5 L 6.7363281 19.5 C 4.1303281 19.5 2.0097656 17.380437 2.0097656 14.773438 C 2.0097656 12.166438 4.1303281 10.046875 6.7363281 10.046875 C 7.4143281 10.046875 8.083875 10.190891 8.671875 10.462891 C 8.927875 10.581891 9.223375 10.586609 9.484375 10.474609 C 9.745375 10.362609 9.9470625 10.145953 10.039062 9.8769531 C 11.039062 6.9329531 13.805922 4.9550781 16.919922 4.9550781 C 20.928922 4.9550781 24.191406 8.2165625 24.191406 12.226562 L 24.191406 14.136719 C 24.191406 14.689719 24.638406 15.136719 25.191406 15.136719 L 25.828125 15.136719 C 27.031125 15.136719 28.009766 16.115359 28.009766 17.318359 C 28.009766 18.521359 27.031125 19.5 25.828125 19.5 C 25.755125 19.5 25.681328 19.496281 25.611328 19.488281 C 25.576328 19.485281 25.543766 19.484375 25.509766 19.484375 L 19.916016 19.484375 C 19.42517 16.640067 16.947284 14.46875 13.964844 14.46875 C 13.547844 14.46875 13.129563 14.51075 12.726562 14.59375 C 12.185563 14.70675 11.839172 15.236344 11.951172 15.777344 C 12.064172 16.318344 12.592766 16.655734 13.134766 16.552734 C 13.404766 16.495734 13.683844 16.46875 13.964844 16.46875 C 16.195844 16.46875 18.011719 18.282672 18.011719 20.513672 C 18.011719 22.744672 16.194844 24.560547 13.964844 24.560547 C 13.437844 24.560547 12.927312 24.460625 12.445312 24.265625 C 11.936313 24.060625 11.350578 24.303406 11.142578 24.816406 C 10.935578 25.328406 11.181359 25.911141 11.693359 26.119141 C 12.415359 26.412141 13.179844 26.560547 13.964844 26.560547 C 16.967586 26.560547 19.457041 24.357215 19.923828 21.484375 L 25.462891 21.484375 C 25.582891 21.495375 25.705125 21.5 25.828125 21.5 C 28.134125 21.5 30.010766 19.623406 30.009766 17.316406 C 30.009766 15.132406 28.328406 13.335391 26.191406 13.150391 L 26.191406 12.226562 C 26.191406 7.1135625 22.032922 2.953125 16.919922 2.953125 z"></path>
                    </path>
                    </g>
                </g>  
              </svg>
              </div>
              <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Province</span>
            </a>
          </li>
          ...
          <li class="mt-0.5 w-full">
            <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="./pages/provinsi.html">
              ...
              <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Subdistrict</span>
            </a>
          </li>
          ...
          <li class="mt-0.5 w-full">
            <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="./pages/provinsi.html">
              ...
              <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Type</span>
            </a>
          </li>
